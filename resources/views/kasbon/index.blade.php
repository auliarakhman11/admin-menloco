...
@section('content')
                    ...
                    <div class="card-header">
                        ...
                        <div class="row">
                            <div class="col-12"><button type="button" class="btn btn-sm btn-primary float-end"
                                    data-bs-toggle="modal" data-bs-target="#modal_add"><i class='bx bxs-plus-circle'></i>
                                    ...
                                    @foreach ($kasbon as $d)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('deleteKasbon', $d->id) }}"
    ...
    <form id="form_add" method="POST" action="{{ route('addKasbon') }}">
        @csrf
    ...
    @foreach ($kasbon as $d)
        <form method="POST" action="{{ route('editKasbon') }}">
            @csrf
            @method('patch')
